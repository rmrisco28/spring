...
# FIRST NORMAL FORM(1NF): 1 정규화(정규형)
# SECOND NORMAL FORM (2NF): 2정규형
# THIRD NORMAL FORM (3NF): 3정규화

# 1NF
# 모든 레코드가 유일해야하고
# ->PRIMARY KEY (NOT NULL UNIQUE) 컬럼이 적어도 하나 있어야한다.
...
INSERT INTO table26
    (name, phone1)
VALUES ('son', '01011112222');

INSERT INTO table26
    (name, phone1, phone2)
VALUES ('son', '01011112222', '01022223333');
...
INSERT INTO table28
    (name, address, work)
    VALUE ('kim', 'seoul', 'intel');

INSERT INTO table28
    (name, address, work)
    VALUE ('lee', 'busan', 'intel');

INSERT INTO table28
    (name, address, work)
    VALUE ('choi', 'seoul', 'tesla');

INSERT INTO table28
    (name, address, work)
    VALUE ('kim', 'jeju', 'google');
...
# 같은 이름, 지역, 등의 동일 값이 있을 수 있기 때문에 학번, 주민번호등을 부여
